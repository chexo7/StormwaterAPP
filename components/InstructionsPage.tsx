...
const instructionsContent = {
  es: {
    ...
    steps: [
      ...
      'Sigue el orden documentado: carga Drainage Areas, asigna cada Discharge Point, luego las Drainage Subareas, y finalmente habilita la capa Soil Layer from Web Soil Survey antes de incorporar Land Cover y LOD.',
      'Revisa el panel de capas para activar o desactivar la visibilidad, cambiar estilos y seleccionar qué capa editar.',
      'Usa el mapa para revisar geometrías. Puedes editar atributos clave como el HSG (selección manual A/B/C/D), el Discharge Point # (DP-##) de cada área de drenaje y la cobertura del suelo desde los controles contextuales.',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Confirma que cada subárea tenga Land Cover y que la capa de suelos (WSS), recortada al contorno combinado de las Drainage Areas, cuente con el grupo hidrológico del suelo (HSG) seleccionado manualmente.',
        ],
      },
    ],
  ...
  en: {
    ...
    steps: [
      ...
      'Follow the documented order: upload Drainage Areas, assign every Discharge Point, then load the Drainage Subareas before enabling the Soil Layer from Web Soil Survey, and finally add Land Cover and LOD.',
      'Review the layer panel to toggle visibility, adjust styles, and choose which layer is currently editable.',
      'Use the map to inspect geometries. Contextual controls let you edit key attributes like the manually selected Hydrologic Soil Group (HSG), the Discharge Point # (DP-##) for each drainage area, and Land Cover.',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Ensure every subarea carries Land Cover information and that the soil layer (WSS)—cropped to the combined Drainage Areas outline—has a Hydrologic Soil Group (HSG) chosen manually.',
        ],
      },
    ],
