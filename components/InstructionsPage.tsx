...
const instructionsContent = {
  es: {
    ...
    steps: [
      ...
      'Usa el mapa para revisar geometrías. Puedes editar atributos clave como Housing (HSG), el Discharge Point # (DP-01 a DP-20) y la cobertura del suelo desde los controles contextuales.',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Carga por separado las Áreas de Drenaje generales (una por punto de descarga) y las Subáreas de Drenaje asociadas mediante el campo PARENT_DA o usando el selector de Discharge Point #.',
          ...
          'Nombrar tus archivos como DA-TO-DP-##.zip o SUB-DA-##.zip permitirá asociarlos automáticamente al punto de descarga correspondiente.',
        ],
      },
    ],
  ...
  en: {
    ...
    steps: [
      ...
      'Use the map to inspect geometries. Contextual controls let you edit key attributes like Housing (HSG), the Discharge Point # (DP-01 through DP-20), and Land Cover.',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Upload general Drainage Areas (one per discharge point) and their Drainage Subareas, linking each subarea with the PARENT_DA field or via the Discharge Point # picker.',
          ...
          'Naming your inputs as DA-TO-DP-##.zip or SUB-DA-##.zip lets the app auto-associate them with the corresponding discharge point.',
        ],
      },
    ],
