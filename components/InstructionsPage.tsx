...
const instructionsContent = {
  es: {
    ...
    steps: [
      ...
      'Primero sube las Drainage Areas, asigna un Discharge Point (DP-##) a cada polígono y luego incorpora las Drainage Subareas vinculándolas a esos mismos DP. La capa de suelos (WSS) puede cargarse en cualquier momento, y la capa Land Cover seguirá habilitándose cuando el WSS esté presente.',
  ...
  en: {
    ...
    steps: [
      ...
      'Load the Drainage Areas first, assign a Discharge Point (DP-##) to every polygon, then import the Drainage Subareas and link them to those discharge points. The WSS soil layer can now be uploaded at any time, and the Land Cover layer remains available once that soil layer is present.',
