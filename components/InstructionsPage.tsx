...
const instructionsContent = {
  es: {
    ...
    steps: [
      ...
      'Usa el mapa para revisar geometrías. Puedes editar atributos clave como el grupo hidrológico del suelo (HSG), el Discharge Point # (DP-##) de cada área de drenaje y la cobertura del suelo desde los controles contextuales.',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Confirma que cada subárea tenga Land Cover y que, una vez habilitada la capa WSS, asignes manualmente el grupo hidrológico del suelo (HSG).',
        ],
      },
    ],
  ...
  en: {
    ...
    steps: [
      ...
      'Use the map to inspect geometries. Contextual controls let you edit key attributes like the Hydrologic Soil Group (HSG), the Discharge Point # (DP-##) for each drainage area, and Land Cover.',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Ensure every subarea carries Land Cover information and, once the WSS layer is unlocked, assign its Hydrologic Soil Group (HSG) manually.',
        ],
      },
    ],
