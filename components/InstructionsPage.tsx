...
const instructionsContent = {
  es: {
    ...
    steps: [
      ...
      'Carga las capas LOD, Drainage Areas y Drainage Subareas y asigna sus Discharge Points (DP-##); al completar estos pasos se habilita la carga del Soil Layer from Web Soil Survey con HSG editables.',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Confirma que cada subárea tenga Land Cover y que, tras recortar la capa de suelos (WSS) al contorno de las Drainage Areas, cada polígono cuente con un HSG definido manualmente (A, B, C o D).',
        ],
      },
    ],
  ...
  en: {
    ...
    steps: [
      ...
      'Provide the LOD, Drainage Areas, and Drainage Subareas layers and assign their DP-## values; once complete the Soil Layer from Web Soil Survey upload unlocks with editable HSG values.',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Ensure every subarea carries Land Cover information and that, after clipping the soil layer (WSS) to the Drainage Area footprint, each polygon has a manually assigned HSG (A, B, C, or D).',
        ],
      },
    ],
