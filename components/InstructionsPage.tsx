...
const instructionsContent = {
  es: {
    ...
    steps: [
      ...
      'Usa el mapa para revisar geometrías. Puedes editar atributos clave como Housing (HSG), el Discharge Point # de cada Drainage Area y la cobertura del suelo desde los controles contextuales.',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Los archivos llamados DA-TO-DP##.zip o SUB-DA##.zip se detectan automáticamente y se vinculan al Discharge Point correspondiente.',
  ...
  en: {
    ...
    steps: [
      ...
      'Use the map to inspect geometries. Contextual controls let you edit key attributes like Housing (HSG), each Drainage Area\'s Discharge Point #, and Land Cover.',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Files named DA-TO-DP##.zip or SUB-DA##.zip are auto-detected and tied to the matching Discharge Point.',
