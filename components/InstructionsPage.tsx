...
const instructionsContent = {
  es: {
    ...
    steps: [
      ...
      'Usa el mapa para revisar geometrías. Puedes editar atributos clave como Housing (HSG), el Discharge Point # (DP-01..DP-20) de cada área de drenaje y la cobertura del suelo desde los controles contextuales.',
  ...
  en: {
    ...
    steps: [
      ...
      'Use the map to inspect geometries. Contextual controls let you edit key attributes like Housing (HSG), the Discharge Point # (DP-01..DP-20) for each drainage area, and Land Cover.',
