        ...
        <div className="flex items-start justify-between p-4 border-b border-gray-700">
          <div>
            ...
            <p className="text-sm text-gray-300 mt-1">
              ...
              temporalmente durante esta sesión y se usarán en la próxima ejecución de "HydroCAD".
              Al recargar la página se restaurarán los valores obtenidos desde el servidor.
            </p>
          </div>
          <button
            onClick={onClose}
