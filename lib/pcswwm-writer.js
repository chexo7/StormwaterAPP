...
export function insertAfterSection(inp, section, block) {
...
export function buildSUBCATCHMENTS(input) {
  const lines = [
...
export function buildSUBAREAS(input) {
  const lines = [
...
export function buildINFILTRATION(input) {
...
export function buildOUTFALLS(input) {
